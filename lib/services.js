...
// `name` is the on-page display name; `seoTitle` is the shorter, city-qualified
// <title> so search results don't truncate mid-phrase.
export const services = [
  {
    ...
    seoTitle: "Commercial AV Installation in Columbus, OH",
    cardDescription:
  ...
  },
  {
    ...
    seoTitle: "Security Camera & Access Control in Columbus, OH",
    cardDescription:
  ...
  },
  {
    ...
    seoTitle: "Digital Signage Integration in Columbus, OH",
    cardDescription:
  ...
  },
  {
    ...
    seoTitle: "Structured Cabling Installation in Columbus, OH",
    cardDescription:
  ...
  },
  {
    ...
    seoTitle: "Business Phone Systems in Columbus, OH",
    cardDescription:
  ...
  },
  {
    ...
    seoTitle: "Restaurant Technology Installation in Columbus, OH",
    cardDescription:
