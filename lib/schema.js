...
// TechOne Smart Shield is the same company's subscription program, on its
// own domain. Declaring the relationship in both directions keeps the two
// sites from reading as unrelated businesses that happen to share a phone
// number. The reciprocal parentOrganization lives in the Smart Shield repo.
export const SMART_SHIELD_URL = "https://techonesmartshield.com";
export const SMART_SHIELD_ID = `${SMART_SHIELD_URL}/#organization`;
...
export const organizationJsonLd = {
  ...
  subOrganization: {
    "@type": "Organization",
    "@id": SMART_SHIELD_ID,
    name: "TechOne Smart Shield",
    url: SMART_SHIELD_URL,
  },
  openingHoursSpecification: [
    ...
    // Google reads an all-zero open/close window as "closed all day".
    {
      "@type": "OpeningHoursSpecification",
      dayOfWeek: business.hours.closedDays,
      opens: "00:00",
      closes: "00:00",
    },
  ],
